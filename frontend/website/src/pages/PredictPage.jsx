...
export default function PredictPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://dsp-environmentaltracker-1.onrender.com/predict", {
        method: "POST",
  ...
  const sendFeedback = async (vote) => {
    ...
    await fetch("https://dsp-environmentaltracker-1.onrender.com/api/feedback", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
